  ...
  return (
    <section className="gradient-hero min-h-[62vh] flex flex-col items-center justify-center px-4 pt-10 pb-12 relative overflow-hidden">
      ...
      <motion.a
        ...
        className="mt-7 gradient-warm text-primary-foreground px-7 py-2.5 rounded-2xl font-semibold text-sm sm:text-base shadow-warm cursor-pointer inline-flex items-center gap-2"
      >
        ดูสินค้าทั้งหมด
